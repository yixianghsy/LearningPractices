<div class="topMenu">
  ...
  <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn/manager/item/js/e3mall.js"></script>
  <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn/manager/item/js/jquery.cookie.js"></script>
</div>