...
<head>
    ...
    <title>注册-个人用户</title>
    <link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//sso/css/headerfooter.css" />
...
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//sso/js/passport.common.js?v20140531"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//sso/js/jquery.alerts.js"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//sso/js/png.js?v20140521"></script>
</head>
<body>
		<!-- header -->
		<div class="header">
			<a href="http://www.sylianxizhuanyong.cn"><img src="http://resource.sylianxizhuanyong.cn//sso/images/logo.png" border="0" /><span>欢迎注册</span></a>
		</div>

		<!--mainStart-->
						<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//sso/css/reg.css?v20140432" />
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//sso/js/allMail.js?v20140430"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//sso/js/reg.js?v20150122"></script>
<!-- reg_main -->
    ...
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.e3mall.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《福驿商城用户注册协议》</font></a>
			</span>
...
<!--mainOver-->
		...
		<div class="footer">
			<span>
				<a href="http://www.sylianxizhuanyong.cn/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> |
				<a href="http://www.sylianxizhuanyong.cn/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> |
				<a href="http://www.sylianxizhuanyong.cn/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> |
				<a href="http://www.sylianxizhuanyong.cn/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> |
				<a href="http://supplier.e3mall.cn/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
			</span>
			<p> 
				北京宜立方电子商务有限公司<br />
				北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.sylianxizhuanyong.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 福驿商城 e3mall.cn 版权所有<br />
			</p>
		</div>
		<!-- /footer -->
