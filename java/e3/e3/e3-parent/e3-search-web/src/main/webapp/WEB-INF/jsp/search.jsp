...
<title>${query} - 商品搜索 - 福驿商城</title>
	<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//search/css/productList.css" />
<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//search/css/base_w1200.css" />
<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//search/css/common.css" />
<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//search/css/jquery.alerts.css" />
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/jquery-1.5.1.min.js"></script>
</head>
<body>
<!-- header start -->
    ...
    <div class="p-list">
      <ul class="list-all">
         ...
         <li>
            <div class="l-wrap">
				<div class="pic">
					<a class="trackref" href="http://item.sylianxizhuanyong.cn/item/${item.id}.html" title="" target="_blank">
	            ...
	            <div class="title-a">
	                <a class="trackref presaleSign_225865" href="http://item.sylianxizhuanyong.cn/item/${item.id}.html" target="_blank">${item.title }</a>
	            </div>
	        	<div class="title-b" style=""><a class="trackref" href="http://item.sylianxizhuanyong.cn/item/${item.id}.html" target="_blank">${sell_point }</a></div>
	            <div class="comment">
...
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/common.js?v=20160713"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/cart.js?v=20160713"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/jquery.alerts.js"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/NewVersion.js?v=20160713"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/cookie.js?v=20160416222"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/shadow.js?v=20160416"></script>
</div>
</html>