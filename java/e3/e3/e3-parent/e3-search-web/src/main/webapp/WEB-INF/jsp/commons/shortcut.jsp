...
<div class="topMenu">
    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://sso.sylianxizhuanyong.cn/page/login">请登录</a>
      	</span>
      	<a href="https://passport.e3mall.cn/reg/?returnUrl=http%3A//www.sylianxizhuanyong.cn/">免费注册</a>
      </li>
      ...
      <li class="d3 tShow"><a name="sfbest_hp_hp_head_weibo" class="trackref" title="关注福驿商城微博" href="http://weibo.com/sfbest" rel="nofollow" target="_blank"><q></q></a></li>
      <li class="d4 tShow"><q></q><!--微信-->
         <div class="dd">
         <div class="sf_wx_t">关注福驿商城微信</div>
         <div class="sf_wx"></div>
        </div>
        <div class="corner">
          <div class="aBg"></div>
  ...
  <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/e3mall.js"></script>
  <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//search/js/jquery.cookie.js"></script>
</div>