...
<div id="header">
  <div class="header_inner">
    <div class="logo">
			...
			<div class="logo-text">
				<img src="http://resource.sylianxizhuanyong.cn//search/images/html/logo_word.jpg">
			</div>
		</div>
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://cart.sylianxizhuanyong.cn" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
