    ...
    <div class="logo">
        ...
        <div class="index_topad" id="playLogo" style="">
            <a href="/html/activity/1472179566.html" target="_blank">
              <img src="http://resource.sylianxizhuanyong.cn//portal/images/html/20160829181637762.gif">
            </a> 
        </div>
		<a name="sfbest_hp_hp_head_logo" href="http://www.sylianxizhuanyong.cn" class="trackref logoleft">
		</a>
		<div class="logo-text">
			<img src="http://resource.sylianxizhuanyong.cn//portal/images/html/logo_word.jpg">
		</div>
		</div>
    <div class="index_promo"></div>
    <div class="search">
      <form action="http://search.sylianxizhuanyong.cn/search.html" id="searchForm" name="query" method="GET">
