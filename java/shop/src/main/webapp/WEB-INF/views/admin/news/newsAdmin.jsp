        ...
        <table class="table table-responsive table-striped">
            ...
            <c:forEach items="${page.result}" var="news">
                <tr pid="${news.id}">
                    ...
                    <td>${news.title}</td>
                    <td><a class="btn btn-info btn-xs" href="${ctx}/admin/news/${order.id}">查看</a> <a
                            class="btn btn-info btn-xs del-news-btn">修改</a> <a class="btn btn-info btn-xs del-news-btn">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
