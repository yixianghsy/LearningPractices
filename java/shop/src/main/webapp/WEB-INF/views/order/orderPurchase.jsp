        ...
        <div class="row">
            ...
            <div class="col-sm-6 list-group">
                <c:forEach items="${userCouponList}" var="userCoupon">
                    <a href="#" class="list-group-item couponItem">
                        <h4 class="list-group-item-heading">满${userCoupon.achieveAmount}减</h4>
                        <p class="list-group-item-text">${userCoupon.reduceAmount}</p>
                        <input type="hidden" value="${userCoupon.userCouponCode}"/>
                        <input type="hidden" value="${userCoupon.couponId}"/>
                    </a>
                </c:forEach>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="userCouponCode" class="col-sm-2 control-label">优惠券</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="userCouponCode" name="userCouponCode"/>
                    </div>
                </div>
