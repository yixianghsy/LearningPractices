        ...
        <div class="col-md-6 col-md-offset-3">
            <form:form id="inputForm" role="form" action="${ctx}/product/edit"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input minlength="6" required class="form-control" value="${product.title}" type="text"
                               id="title" name="title"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" required class="form-control" type="text" value="${product.point}"
                               id="point" name="point"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" required type="number" value="${product.stock}" id="stock"
                               name="stock"/>
                    </div>
                </div>
                <div class="form-group">
