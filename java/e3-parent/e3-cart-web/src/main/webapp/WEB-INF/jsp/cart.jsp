...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//cart/css/jquery.alerts.css?v=20160713" />
<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//cart/css/head.css?v=20160713" />
<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//cart/css/cart.css?v=20160630">
<link rel="stylesheet" type="text/css" href="http://resource.sylianxizhuanyong.cn//cart/css/common.css?v=201321222" />
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/jquery-1.5.1.min.js?v=20160713"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/jquery.price_format.2.0.min.js"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/jquery.alerts.js?v=20160713"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/cart.js?v=20160713"></script>
 <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/cookie.js?v=20160416222"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/shadow.js?v=20160416"></script>
<script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//cart/js/common.js"></script>


   <title>我的购物车 - 福驿商城</title>
<body> 
...
<div class="cartMain">
	...
	<div class="cartMain">
				...
				<div class="cartPInfo" id="danjian-0-229363">
					<div class="clearit">
						...
						<div class="pItem pGoods">
							<div class="cart_pimg">
								<a target="_blank" title="${cart.title }" href="http://item.sylianxizhuanyong.cn/item/${cart.id }.html">
								<img src="${cart.image }" style="width: 60px;height: 60px;"/>
								</a>
							</div>
							<div class="cart_pname">
								<div>
								<a target="_blank" href="http://item.sylianxizhuanyong.cn/item/${cart.id }.html">${cart.title }</a>
								</div>
      ...
      <div class="cartJsuan">
         <input onclick="javascript:document.location.href='http://www.sylianxizhuanyong.cn'" class="goshop" value="继续购物" type="button">
         <input onclick="javascript:document.location.href='http://order.sylianxizhuanyong.cn/order/order-cart.html'" class="jiesuan youxuan" value="去结算" type="button">
