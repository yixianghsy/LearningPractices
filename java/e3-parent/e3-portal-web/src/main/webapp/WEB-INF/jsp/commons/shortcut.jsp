...
<div class="topMenu">
  <div class="pW">
    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	...
      	<a href="http://sso.sylianxizhuanyong.cn/page/register">免费注册</a>
      </li>
  ...
  <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//portal/js/e3mall.js"></script>
  <script type="text/javascript" src="http://resource.sylianxizhuanyong.cn//portal/js/jquery.cookie.js"></script>
</div>