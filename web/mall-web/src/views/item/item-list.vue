    ...
    <div>
        ...
        <el-form ref="searchForm" :inline="true" :model="searchMap" style="margin-top: 20px">
         ...
         <el-table
            ...
            <el-table-column prop="title" label="商品标题" width="90"></el-table-column>
            <el-table-column prop="cid" label="叶子类目" ></el-table-column>
...
export default {
    ...
    methods: {
        fetchData() {
            itemApi.getList(this.currentPage, this.pageSize, this.searchMap).then(response => {
